...
dataDF_14_15 %>%
  ...
  geom_boxplot() +
  ggtitle("Admission Rate vs Completion Rate Category")
...
dataDF_14_15_cleanSAT %>%
  ...
  geom_boxplot() +
  ggtitle("Average SAT Score vs Completion Rate Category")
...
dataDF_14_15_cleanSize %>%
  ...
  geom_boxplot() +
  ggtitle("Undergrad Enrollment vs Completion Rate Category")
...
dataDF_14_15_cleanSize %>%
  ...
  ggtitle("School Size vs Completion Rate Category") + 
...
dataDF_14_15_cleanCost %>%
  ...
  geom_boxplot() +
  ggtitle("Average Cost/Year vs Completion Rate Category")
...
dataDF_14_15 %>%
  ...
  geom_boxplot() +
  ggtitle("Out of State Costs vs Completion Rate Category")
...
dataDF_14_15_cleanRegion %>%
  ...
  geom_bar(position="stack", stat="identity") +
  ggtitle("Region vs Completion Rate Category") + 
  theme(axis.text.y = element_blank()) +
  xlab("Completion Rate")
