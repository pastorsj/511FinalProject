...
(low.grad <- nrow(df.clean[(df.clean$Comp.Rate.17_18.BIN == 'Low'),]))
# Number of schools with high graduation rate
(high.grad <- nrow(df.clean[(df.clean$Comp.Rate.17_18.BIN == 'High'),]))

# Probability of Low Completion Rate given Region is South
nrow(df.clean[(df.clean$Region == 'South') & (df.clean$Comp.Rate.17_18.BIN == 'Low'),]) / low.grad
# Probability of Low Completion Rate given Region is West
nrow(df.clean[(df.clean$Region == 'West') & (df.clean$Comp.Rate.17_18.BIN == 'Low'),]) / low.grad
# Probability of Low Completion Rate given Region is Northeast
nrow(df.clean[(df.clean$Region == 'Northeast') & (df.clean$Comp.Rate.17_18.BIN == 'Low'),]) / low.grad
# Probability of Low Completion Rate given Region is North Central
nrow(df.clean[(df.clean$Region == 'North Central') & (df.clean$Comp.Rate.17_18.BIN == 'Low'),]) / low.grad

# Probability of High Completion Rate given Region is South
nrow(df.clean[(df.clean$Region == 'South') & (df.clean$Comp.Rate.17_18.BIN == 'High'),]) / high.grad
# Probability of High Completion Rate given Region is West
nrow(df.clean[(df.clean$Region == 'West') & (df.clean$Comp.Rate.17_18.BIN == 'High'),]) / high.grad
# Probability of High Completion Rate given Region is Northeast
nrow(df.clean[(df.clean$Region == 'Northeast') & (df.clean$Comp.Rate.17_18.BIN == 'High'),]) / high.grad
# Probability of High Completion Rate given Region is North Central
nrow(df.clean[(df.clean$Region == 'North Central') & (df.clean$Comp.Rate.17_18.BIN == 'High'),]) / high.grad
```
